...
#fig = px.histogram(consecutive_rental_data["delayed_checkin"],x="Delayed checkins")
#st.plotly_chart(fig)
...
with st.form("Threshhold"):
    ...
    if submit:
        ...
        # Number of delayed checkin avoided
        #avoided_checkin_delays = 0
        #try:
        ...
        #except:
        #    avoided_checkin_delays = 0 # there were no avoided checkin delays

        # Number cancellation (due to checkin delays) avoided
        #avoided_cancellation = 0
        #try:
            
        avoided_cancellation = len(cancellation_df_selected[cancellation_df_selected["delayed_checkin_in_minutes"] < threshold])
        #except:
        #    avoided_cancellation = 0 # there were no avoided cancellations
